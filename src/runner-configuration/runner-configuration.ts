import { AutoscalerConfiguration } from "./autoscaler-configuration";
...
export interface RunnerConfiguration {
   ...
   *
   * @see https://docs.gitlab.com/runner/executors/docker_autoscaler/
   */
  readonly autoscaler: AutoscalerConfiguration;
...
export type Executor = "instance" | "docker-autoscaler";
